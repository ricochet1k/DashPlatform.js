...
import { BinaryData, Identifier, IdentifierBytes32, StateTransition } from "../2.0.0/generated_bincode.js";
 ...
 */
export async function signTransitionWithRawKey(st, pubkey, private_key) {
...
async function makeContractId(owner_id, identity_nonce) {
