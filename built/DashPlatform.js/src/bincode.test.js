...
import { decode, encode, Enum, Int8, String, } from "./bincode.js";
import { BinaryData, DataContractCreateTransition, StateTransition, IdentityPublicKeyV0, KeyType, Purpose, SecurityLevel, IdentityPublicKey, OutPoint } from "../2.0.0/generated_bincode.js";
import * as KeyUtils from "./key-utils.js";
import { signTransitionWithRawKey } from "./sign.js";
...
it("should encode/decode DataContractCreateTransitions", async () => {
    ...
    */
    ...
    // Now sign it
    const private_key = fromHex("6c554775029f960891e3edf2d36b26a30d9a4b10034bb49f3a6c4617f557f7bc");
...
it("should encode/decode IdentityPublicKey", () => {
    ...
    console.log('master_key data (public_key)', (master_key[0].data[0].buffer));
    expect(master_key_bytes).toStrictEqual(new Uint8Array(encode(IdentityPublicKey, master_key)));
