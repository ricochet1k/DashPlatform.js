import { Bool, Bytes, Enum, VariantDiscriminant, FixedBytes, Lazy, Struct, StructTuple, Int128, Int16, Int32, Int64, Int8, Uint128, Uint16, Uint32, Uint64, Uint8, Float64, VarInt, VarUint, Vec, Tuple, Map, Option, String, Nothing, Range, NotSignable, SocketAddr, DISCRIMINANT, VARIANT, ENUM, } from "../src/bincode.js";
import { Transaction } from "../src/bincode_types.js";
 ...
 */
export const BLSPublicKey = StructTuple("BLSPublicKey", FixedBytes(48));
// !ENCODE
/**
 * A BLS Signature is 96 bytes in the scheme used for Dash Core
 * attr since (1.48) , derive (PartialEq , Eq , Ord , PartialOrd , Hash)
 */
export const BLSSignature = StructTuple("BLSSignature", FixedBytes(96));
export const BinaryData = StructTuple("BinaryData", Bytes);
// !ENCODE
/** A dash block hash. */
export const BlockHash = StructTuple("BlockHash", Hash);
...
export const IdentifierBytes32 = StructTuple("IdentifierBytes32", FixedBytes(32));
export const IdentityNonce = VarUint;
// !ENCODE
/** A hash of all transaction inputs */
export const InputsHash = StructTuple("InputsHash", Hash);
 ...
 */
export const MerkleRootMasternodeList = StructTuple("MerkleRootMasternodeList", Hash);
// !ENCODE
/**
 * The merkle root of the quorums
 * hash_newtype forward
 */
export const MerkleRootQuorums = StructTuple("MerkleRootQuorums", Hash);
/** repr u8 */
...
export const PubkeyHash = StructTuple("PubkeyHash", Hash);
/** repr u8 */
...
export const QuorumVVecHash = StructTuple("QuorumVVecHash", Hash);
// !ENCODE
 ...
 */
export const ScriptBuf = StructTuple("ScriptBuf", Bytes);
/** repr u8 */
...
export const Txid = StructTuple("Txid", Hash);
...
export const Identifier = StructTuple("Identifier", IdentifierBytes32);
...
// !ENCODE
export const CoreScript = StructTuple("CoreScript", DashcoreScript);
