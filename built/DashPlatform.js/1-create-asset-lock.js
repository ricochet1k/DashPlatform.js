...
async function main() {
    ...
    console.log();
    let { identityIdHex, txidHex, assetProof } = await createPlatformAssetLock(hdOpts, regFundKey, topupKey, // TODO next change key from wallet
    assetInfo);
    console.log();
    ...
    await createIdentityFromAssetLock(assetKey, masterKey, otherKey, identityIdHex, txidHex, assetProof);
