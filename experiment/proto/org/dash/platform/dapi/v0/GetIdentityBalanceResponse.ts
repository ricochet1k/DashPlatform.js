...
export interface _org_dash_platform_dapi_v0_GetIdentityBalanceResponse_GetIdentityBalanceResponseV0 {
...
export interface _org_dash_platform_dapi_v0_GetIdentityBalanceResponse_GetIdentityBalanceResponseV0__Output {
  'balance'?: (string);
...
export interface GetIdentityBalanceResponse {
  'v0'?: (_org_dash_platform_dapi_v0_GetIdentityBalanceResponse_GetIdentityBalanceResponseV0 | null);
  'version'?: "v0";
}

export interface GetIdentityBalanceResponse__Output {
  'v0'?: (_org_dash_platform_dapi_v0_GetIdentityBalanceResponse_GetIdentityBalanceResponseV0__Output | null);
  'version': "v0";
}
